 ...
 * @author sanik
 */
public class ManageRepairs extends javax.swing.JPanel {
    ...
    public void populateRequestTable() {
        ...
        getstatus.setText(userAccount.getAvail());
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1260, 80));
        ...
        lblservice.setText("SERVICE PROVIDER PROFILE");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 80, 1260, 290));
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
       ...
       if (system.isVoid(getname.getText()) || system.isVoid(getcharge.getText()) || system.isVoid(getcity.getText())
                || system.isVoid(getstatus.getText()) || system.isVoid(getzip.getText()) || system.isVoid(getaddress.getText())
        ...
        userAccount.setAvail(getstatus.getText());
