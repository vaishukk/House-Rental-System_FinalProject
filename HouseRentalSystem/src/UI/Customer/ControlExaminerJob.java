...
public class ControlExaminerJob extends javax.swing.JPanel {
    ...
    public ControlExaminerJob(JPanel userProcess, UserAccount usrAccount, EcoSystem system, Enterprise enterprise, Network network, Organisation organisation) {
        initComponents();
                ...
                if (e.getEnterpriseType() == Enterprise.EnterpriseType.QualityControl) {
                    for (WorkRequest workRequest : e.getWorkQueue().getWrkReqList()) {
                        if (workRequest instanceof ExamineRequest) {
                            if (usrAccount.getUserName().equals(((ExamineRequest) workRequest).getCustomer().getUserName())) {
    ...
    private void initComponents() {
        ...
        tblexaminer.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "JobID", "Examiner", "Merchant", "Address", "City", "State", "Zipcode", "Availibility", "Customer Message", "Examiner Message", "Charge", "Approximation", "OrgType"
            }
        ) {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons8-analyse-64.png"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(47, 47, 47)
                        .addComponent(getmessage, javax.swing.GroupLayout.PREFERRED_SIZE, 642, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(365, 365, 365)
