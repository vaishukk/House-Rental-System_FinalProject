...
public class RecruitExaminerPanel extends javax.swing.JPanel {
    ...
    public RecruitExaminerPanel(JPanel userProcess, Organisation organisation, Network network, Enterprise enterprise, Asset asset, UserAccount userAccount, EcoSystem system) {
        initComponents();
            ...
            for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                for (Organisation org : e.getOrganisationDirectory().getOrganisationList()) {
                    for (UserAccount ua : org.getUserAccountDirectory().getUserAccountList()) {
                        if (ua.getRole() instanceof ExaminerRole) {
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(getmessage, javax.swing.GroupLayout.PREFERRED_SIZE, 552, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(439, 439, 439))
        );
        ...
        jPanel1.add(btnrepairservices, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 360, -1, -1));
            ...
            if (selectedRow >= 0) {
                ...
                for (Network n : system.getNetworkList()) {
                    for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()) {
                        for (Organisation org : e.getOrganisationDirectory().getOrganisationList()) {
                            for (UserAccount ua : org.getUserAccountDirectory().getUserAccountList()) {
                                if (serAcc.getUsername().equals(ua.getUsername())) {
                                    ExamineRequest cr = new ExamineRequest();
                                    cr.setRequestID();
                                    cr.setCustomer(userAccount);
                                    cr.setExaminer(serAcc);
                                    cr.setMerchant(asset.getMerchant());
                                    cr.setStatus("Pending");
                                    cr.setCustomerNote(message);
                                    cr.setAsset(asset);
                                    cr.setOrgType(org.getType());
                                    Sms sms = new Sms(serAcc.getContactnumber(), "Hello! You have one new work request! Please login to know more!");
                                    EcoSystem.sendEmailMessage(serAcc.getMailId(), "Hello! You have one new work request! Please login to know more!");
